...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		register: function register() {
			...
			this.isProcessing = true;
			this.error = {};
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__helpers_api__["post"])('/api/register', this.form).then(function (res) {
